...
public abstract class Dialog_NoLimitColorPicker : Dialog_ColorPickerBase
{
    public const Widgets.ColorComponents EditableRgb = Widgets.ColorComponents.Red | Widgets.ColorComponents.Green | Widgets.ColorComponents.Blue;

    public static readonly Texture2D ColorValuePickerExp;

    protected bool colorValueBarDragging = false;
    ...
    static Dialog_NoLimitColorPicker()
    {
    ...
    protected Dialog_NoLimitColorPicker(Widgets.ColorComponents visibleTextfields, Widgets.ColorComponents editableTextfields) : base(visibleTextfields, editableTextfields)
    {
    }

...
{
    internal class WorkGiver_FightAstrofire : WorkGiver_Scanner
    {
        ...
        public override ThingRequest PotentialWorkThingRequest => ThingRequest.ForDef(VGEDefOf.VGE_Astrofire);
        ...
        {
            return JobMaker.MakeJob(VGEDefOf.VGE_BeatAstrofire, t);
        }

        public static bool FireIsBeingHandled(Astrofire f, Pawn potentialHandler)
        {
            if (!f.Spawned)
            {
                return false;
